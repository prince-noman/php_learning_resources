...
<!-- Mirrored from themesbrand.com/velzon/html/minimal/apps-tasks-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 23:28:36 GMT -->
<head>
                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Profile
                                                        Page Structure</a></h6>
                                                <div class="dropdown">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Velzon
                                ...
                                <div id="todo-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Admin
                                                            Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Marketing & Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="inprogress-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Brand Logo Design</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Change Old App Icon</a></h6>
                                ...
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title "><a href="apps-tasks-details.html" class="link-secondary">Create Product Animations</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Create a Graph of Sketch</a></h6>
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Create a
                                ...
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.html" class="link-secondary">Banner Design for FB & Twitter</a></h6>
...
<!-- Mirrored from themesbrand.com/velzon/html/minimal/apps-tasks-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 23:28:38 GMT -->
</html>