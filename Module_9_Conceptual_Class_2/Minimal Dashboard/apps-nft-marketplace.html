...
<!-- Mirrored from themesbrand.com/velzon/html/minimal/apps-nft-marketplace.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 23:29:18 GMT -->
<head>
            ...
            <div class="page-content">
                <div class="container-fluid">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-1.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-4.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-2.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-5.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-3.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-1.gif" alt="" class="img-fluid rounded mb-1">
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.html" class="text-body">Patterns Arts & Culture</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.html" class="text-body">Evolved Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        <img src="../../../../img.themesbrand.com/velzon/images/img-1.gif" alt="" class="img-fluid explore-img">
                                        <div class="bg-overlay"></div>
                                        <div class="place-bid-btn">
                                            <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.html" class="text-body">Long-tailed Macaque</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.html" class="text-body">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        <img src="../../../../img.themesbrand.com/velzon/images/img-3.gif" alt="" class="img-fluid explore-img">
                                        <div class="bg-overlay"></div>
                                        <div class="place-bid-btn">
                                            <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details.html" class="text-body">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.html" class="text-body">The Chirstoper</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="explore-place-bid-img">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-2.gif" alt="" class="card-img-top explore-img" />
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.html" class="text-body">Trendy Fashion Portraits</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.html" class="text-body">Smillevers Crypto</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="explore-place-bid-img">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-4.gif" alt="" class="card-img-top explore-img" />
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.html" class="text-body">Evolved Reality</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details.html" class="text-body">Abstract Face Painting</a></h5>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.html" class="text-body">Tonya Noble</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../../../../img.themesbrand.com/velzon/images/img-5.gif" alt="" class="card-img-top object-fit-cover" height="120">
                                <div class="card-body text-center">
                                    <img src="assets/images/nft/img-04.jpg" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.html" class="text-body">Kevin Dawson</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.html" class="text-body">Herbert Stokes</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-2.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.html" class="text-body">Thomas Taylor</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-1.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                                    <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile.html" class="text-body">James Price</a></h5>
...
<!-- Mirrored from themesbrand.com/velzon/html/minimal/apps-nft-marketplace.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 23:29:19 GMT -->
</html>